                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href=" {{route('property.list.page')}}" class="dropdown-item">Property List</a>
                                <a href="{{route('property.type.page')}}" class="dropdown-item">Property Type</a>
                                <a href="{{route('property.agent.page')}}" class="dropdown-item">Property Agent</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href=" {{route('error.page')}}" class="dropdown-item">404 Error</a>
                            </div>
                        </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Development By <a class="border-bottom" href="https://www.texlabit.com/">TexLab IT</a>
                        </div>
